package com.hjc.springMVC.web.taglib;
...
public class Functions {
        ...
        public static String organizationName(Long organizationId) {
            SysOrganization organization = organizationService.findOne(organizationId);
        ...
        public static String resourceName(Long resourceId) {
            SysResource resource = resourceService.findOne(resourceId);
            if(resource == null) {
                return "";
            }
